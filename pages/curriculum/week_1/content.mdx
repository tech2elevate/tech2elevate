...
```html
<a href="https://www.target.com/">go to target</a>
```
...
```html
<img src="/images/puppy.jpeg" alt="image of puppy" />
```

- the `src` key can be a folder file path or a link to the image itself
